...
console.log(options)
  ...
  if ((dimensions.round_inset_corners) && (r > 0.0)) {
    let corners = [
      // circle({ r: r, center: true }).translate([r, r]), // sw
      // circle({ r: r, center: true }).translate([w - r, r]), // se
      // circle({ r: r, center: true }).translate([r, l - r]), // nw
      // circle({ r: r, center: true }).translate([w - r, l - r]) // ne
    ]
