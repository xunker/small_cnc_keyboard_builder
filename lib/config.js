...
function stabilizerSpacingForWidth(width) {
  console.log(module.exports.dimensions)
  if (typeof (module.exports.dimensions.stabilizers.cutouts.spacing) == 'object') {
    if (module.exports.dimensions.stabilizers.cutouts.spacing[width]) {
      return module.exports.dimensions.stabilizers.cutouts.spacing[width]
    }

    let validStabilizerSpacings = Object.keys(module.exports.dimensions.stabilizers.cutouts.spacing)
    ...
    return module.exports.dimensions.stabilizers.cutouts.spacing[validStabilizerSpacings[0]]

  } else {
    return module.exports.dimensions.stabilizers.cutouts.spacing
  }
}
